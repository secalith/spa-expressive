<?php
namespace PageView\View\Model;

use Area\Model\AreaModel as AreaModel;
use Area\Service\Factory\AreaServiceFactory;
...
class ViewModel
{
    ...
    {
        $area = ( ! is_object($area))?new AreaModel($area):$area;
    ...
    public function setBlock($block)
    {
        ...
        } elseif($block instanceof ViewModel) {
            $this->block[$block->getData()->getUid()] = $block;
        }
