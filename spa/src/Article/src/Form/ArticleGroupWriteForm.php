...
use \Article\Model\ArticleGroupCreateModel;
use Zend\Form\Form;
use Zend\Hydrator\ClassMethods;
use Zend\InputFilter\InputFilter;

class ArticleGroupWriteForm extends Form
{
    private $formGroups;
    ...
    public function __construct($name = 'form_create', $options = array(), $formGroups=[])
    {
        ...
        $this
            ...
            ->setObject(new ArticleGroupCreateModel())
...
//            ->setInputFilter($this->addInputFilter())
    ...
    protected function addElements($options=null)
    {
        ...
        $this->add(array(
            'name' => 'form_create',
            'type' => \Article\Form\Fieldset\ArticleGroupWriteFieldset::class,
            'options' => array(
