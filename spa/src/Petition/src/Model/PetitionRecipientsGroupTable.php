...
use Petition\Model\PetitionRecipientsGroupModel;
use Zend\Db\TableGateway\TableGateway;
use Common\Model\GenerateUUIDTrait;

class PetitionRecipientsGroupTable
{
...
//        $resultSet->next();
     ...
     */
    public function getItem(string $uid) : PetitionRecipientsGroupModel
    {
    ...
    public function saveItem(PetitionRecipientsGroupModel $item)
    {
