...
use Petition\Model\RecipientsGroupAssignModel;
use Zend\Db\TableGateway\TableGateway;
use Common\Model\GenerateUUIDTrait;

class RecipientsGroupAssignTable
{
...
//        $resultSet->next();
     ...
     */
    public function getItem(string $uid) : RecipientsGroupAssignModel
    {
    ...
    public function saveItem(RecipientsGroupAssignModel $item)
    {
