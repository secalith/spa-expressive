...
use Petition\Model\RecipientsGroupModel;
use Zend\Db\TableGateway\TableGateway;
use Common\Model\GenerateUUIDTrait;

class RecipientsGroupTable
{
...
//        $resultSet->next();
     ...
     */
    public function getItem(string $uid) : RecipientsGroupModel
    {
    ...
    public function saveItem(RecipientsGroupModel $item)
    {
