...
use \Petition\Model\PetitionSignatureCreateModel;
use Zend\Form\Form;
use Zend\Hydrator\ClassMethods;
use Zend\InputFilter\InputFilter;

class PetitionSignatureWriteForm extends Form
{
    private $formGroups;
    ...
    public function __construct($name = 'form_create', $options = array(), $formGroups=[])
    {
        ...
        $this
            ...
            ->setObject(new PetitionSignatureCreateModel())
...
//            ->setInputFilter($this->addInputFilter())
    ...
    protected function addElements($options=null)
    {
        ...
        $this->add(array(
            'name' => 'form',
            'type' => \Petition\Form\Fieldset\PetitionSignFieldset::class,
            'options' => array(
