...
use \Application\Model\ApplicationCreateModel;
use Zend\Form\Form;
use Zend\Hydrator\ClassMethods;
use Zend\InputFilter\InputFilter;

class ApplicationWriteForm extends Form
{
    private $formGroups;
    ...
    public function __construct($name = 'form_create', $options = array(), $formGroups=[])
    {
        ...
        $this
            ...
            ->setObject(new ApplicationCreateModel())
...
//            ->setInputFilter($this->addInputFilter())
    ...
    protected function addElements($options=null)
    {
        ...
        $this->add(array(
            'name' => 'form_create',
            'type' => \Application\Form\Fieldset\ApplicationWriteFieldset::class,
            'options' => array(
